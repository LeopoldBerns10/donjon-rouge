    ...
    .addFields(
      ...
      },
      {
        ...
        value: [
          ...
          '`/refreshgdc [dr1|dr2]` — Actualise l\'embed GDC',
          '`/refreshldc [dr1|dr2]` — Actualise l\'embed LDC',
          '`/refreshraids` — Actualise l\'embed Raid Capital',
          '`/refreshjdc` — Actualise l\'embed JDC',
          '`/resultats <type>` — Poste les résultats d\'un événement',
          ...
          '`/setupguerre` — Recrée les 6 embeds de guerre',
          '`/setuprappels` — Recrée les 6 embeds de rappels',
          '`/setuppanel` — Recrée le panel Sauron',

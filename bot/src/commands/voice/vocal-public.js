...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('vocal-public')
    .setDescription('Rend ton salon vocal public (remet la permission du rôle Lié)'),
  ...
  async execute(interaction) {
    ...
    await interaction.reply({ content: '🔓 Salon rendu public — le rôle Lié peut à nouveau rejoindre.', ephemeral: true })
  },
}

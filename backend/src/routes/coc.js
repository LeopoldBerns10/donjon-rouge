...
import { clan, members, war, warlog, raids, cwl, player, ldcCurrent, ldcCurrentDR2, ldcWar, clanByKey, membersByKey, warByKey, warlogByKey } from '../controllers/cocController.js'
...
router.get('/ldc/dr2/current', ldcCurrentDR2)
